   ...
   <div className="top-div">
    ...
    <div className="container-1">
      ...
      <div className="pentagon-not-flipped light-theme"></div> */}
        ...
        <p className="para">
          For starters, 2026 will witness the 41th edition of Spardha, a festival which has grown from strength to strength ever since its inception. After all these successful editions, Spardha, today stands as the largest inter-collegiate sporting event of India.
        </p>
      </div>
      <div className="rectangle-2">
      {/* <div className="pentagon-flipped light-theme"></div>
