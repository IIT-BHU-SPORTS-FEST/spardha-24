...
const Khokho = (props) => {
  return (
    <EventCard
      captainsArray={[new Person("Varadaraj Santhosh Chowhan (M)", "9561820241", "ygireesh.reddy.eee21@itbhu.ac.in"), new Person("Saloni Sharma (W)", "8392940227", "saloni.sharma.civ22@itbhu.ac.in")]}
      imageSrc={khokho}
      eventName="Khokho"
...
const Squash = (props) => {
  return (
    <EventCard
      captainsArray={[new Person("Harsh (M)", "7042626767", "hemank.vats.apd20@itbhu.ac.in"), new Person("Arunima Bhatnagar(W)", "9630886703", "saloni.sharma.civ22@itbhu.ac.in")]}
      imageSrc={squash}
      eventName="Squash"
